...
\sectionheading{Bio}
\vspace{-1.8em}
{\fontsize{10}{15}\selectfont{\setlength{\parindent}{0pt}\justify{Strong on research, planning, coordinating with partners. The fastest ever dev to complete an ebanx (payment provider) integration---I beat Spotify! Not the best at moving fast and breaking things (I value transparency). Love tmux, vim, static fp. Rely on data, high impact social goals for max motivation. I was a freelance editor once; I write great docs!\par}}}
\vspace{1em}
